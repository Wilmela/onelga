...
const AnnouncementDashboardCard = ({
  _id,
  title,
  date,
  isPublished,
  ...
  return (
    <div className="group relative flex flex-col min-h-40 bg-white border border-slate-200 hover:border-app-blue/50 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-lg">
      <div className="p-5 flex-1">
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-bold font-montserrat text-slate-800 leading-tight line-clamp-2">
            {title}
          </h3>
          <div className="p-text max-w-[30ch] wrap-break-word">
            {cleanText(content)}
          </div>
        </div>
      </div>
