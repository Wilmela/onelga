  ...
  return (
    <section>
      <div className="bg-app-blue p-8 text-white text-center p-y">
        ...
        <h1 className="text-3xl md:text-4xl font-bold tracking-tight mt-12 font-montserrat">
          Privacy Policy
        </h1>
        <p className="mt-2 text-green-100 font-medium font-heebo">
      ...
      <MaxWidthWrapper className="overflow-hidden p-y ">
        <div className="p-8 md:p-12 space-y-10">
          <section>
            <p className="text-gray-600 leading-relaxed font-heebo">
          ...
          <div className="grid gap-10">
            ...
            <section className="flex gap-4">
              ...
              <div>
                <h2 className="text-xl font-bold font-roboto text-gray-900 mb-3">
                  1. Information We Collect
                </h2>
            ...
            <section className="flex gap-4">
              ...
              <div>
                <h2 className="text-xl font-roboto font-bold text-gray-900 mb-3">
                  2. How We Collect Data
                </h2>
            ...
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-100">
              <h2 className="text-xl font-roboto font-bold text-gray-900 mb-4">
                Your Rights & Data Security
              </h2>
              <p className="text-gray-600 font-heebo text-sm leading-relaxed mb-4">
        ...
        <div className="bg-gray-50 border-t border-gray-100 p-6 text-center">
          <p className="text-xs text-gray-500 font-medium font-heebo">
