  ...
  const NEWS_TABS = [
    {
      ...
      description:
        "Draft announcements and publish updates to your audience instantly.",
    ...
    },
    {
      ...
      description:
        "Review, edit, or archive existing news announcements and monitor engagement metrics.",
      href: "/dashboard/announcements/view",
